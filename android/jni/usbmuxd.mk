...
LOCAL_CFLAGS := -DANDROID -DHAVE_STPCPY -DPACKAGE_STRING=\"1.0.9\" -DPACKAGE_VERSION=\"1.0.9\" -DPACKAGE_NAME=\"usbmuxd\" -O2 -Wall -DHAVE_SYS_TYPES_H -D__USB_H__ -D__UTILS_H__ -D__CLIENT_H__ -DPLIST_FORMAT_XML=\".plist\"
...
LOCAL_SHARED_LIBRARIES := libc libplist libusbmuxd libusb
